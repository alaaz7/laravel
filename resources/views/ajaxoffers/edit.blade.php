...
<p>{{__('messages.Add your Offer')}}</p>
<br>
...
<form class="form-horizontal" method="POST" action="{{route('offers.update',$offer -> id)}}">
   ...
   <label for="exampleInputEmail1">أختر صوره العرض</label>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="name_ar" value="{{$offer -> name_ar}}" placeholder="{{__('messages.Offer Name')}}" name="name_ar">
        @error('name_ar')
        <small class="form-text text-danger">{{$message}}</small>
        @enderror
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="name_en" value="{{$offer -> name_en}}" placeholder="{{__('messages.Offer Name')}}" name="name_en">
        @error('name_en')
        <small class="form-text text-danger">{{$message}}</small>
        @enderror
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="price" value="{{$offer -> price}}" placeholder="{{__('messages.Offer Price')}}" name="price">
        @error('price')
        <small class="form-text text-danger">{{$message}}</small>
        @enderror
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="details_ar" value="{{$offer -> details_ar}}" placeholder="{{__('messages.Offer Details')}}" name="details_ar">
        @error('details_ar')
        <small class="form-text text-danger">{{$message}}</small>
        @enderror
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="details_en" value="{{$offer -> details_en}}" placeholder="{{__('messages.Offer Details')}}" name="details_en">
        @error('details_en')
        <small class="form-text text-danger">{{$message}}</small>
        @enderror
      </div>
